...
const app_template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\r\n<html lang="en">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<link rel="icon" href="' + assets2 + `/favicon.png" />\r
		...
		<link href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" rel="stylesheet">\r
		<link rel="preconnect" href="https://fonts.googleapis.com">\r
		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\r
		<link href="https://fonts.googleapis.com/css2?family=Roboto+Mono:ital,wght@0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">\r
		<script>\r
			console.log('%cCreated by K\u0131ra\xE7 Arma\u011Fan \xD6nal \u{1F984}', 'padding: 0.3rem 1.5rem; font-family: Consolas; font-size: 1.2em; line-height: 1.4em; color: white; background-color: #4158D0; background-image: linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%);');\r
		<\/script>\r
		<style>\r
			* {\r
				padding: 0;\r
...
\r
			::-webkit-scrollbar-track {\r
				box-shadow: inset 0 0 11px 11px rgba(0, 0, 0, 0.05);\r
				border: solid 2px transparent;\r
				border-radius: 11px;\r
			}\r
\r
			::-webkit-scrollbar-thumb {\r
				box-shadow: inset 0 0 11px 11px rgba(0, 0, 0, 0.1);\r
				border: solid 2px transparent;\r
				border-radius: 11px;\r
			}\r
\r
			::-webkit-scrollbar-thumb:hover {\r
				box-shadow: inset 0 0 11px 11px rgba(0, 0, 0, 0.2);\r
			}\r
\r
...
\r
			::selection {\r
				color: white;\r
				background: #195bff;\r
				text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.5);\r
			}\r
		\r
		</style>\r
		` + head + "\r\n	</head>\r\n	<body>\r\n		<div>" + body + "</div>\r\n	</body>\r\n</html>\r\n";
